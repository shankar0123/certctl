...
> **Actively maintained — shipping weekly.** Found something? [Open a GitHub issue](https://github.com/shankar0123/certctl/issues) — issues get triaged same-day. CI runs 1,521+ tests with race detection, static analysis, and vulnerability scanning on every commit.
